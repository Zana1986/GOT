            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <ul class="list-unstyled">
                        <li><span class="label label-info">Sitz</span><a href="/ort/${haus.sitz.standOrt.ortName}">${haus.sitz.name}</a></li>
                        <li><span class="label label-info">Motto</span>${haus.motto}</li>
                        <li><span class="label label-info">Wappen</span>${haus.wappen}</li>
                        <#if haus.burg??>
                        <li><span class="label label-info">Ansehen</span><a href="/ort/${haus.burg.standOrt.ortName}">${haus.burg.name}</a></li>
                        </#if>
                    </ul>
                </div>
            </div>
